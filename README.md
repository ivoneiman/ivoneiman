...
- **Backend/Programación:** Java, Python, Rust, SQL, Node.js
...
**Product & SEO Developer | Eldorado Research Group (Estados Unidos)**
...
- Licenciatura en Sistemas — en curso (~50% completado)
- Analista Programador Universitario — en curso (últimas 2 materias)
